...
import { Copy, Star, Cpu, Layers, Zap, ExternalLink, Search, X } from 'lucide-react';
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Pre-built model recipes. Clone to the Builder and start training instantly.
            </p>
          </div>
        ...
        {filtered.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <p className="text-sm text-slate-500 max-w-xs text-center">
              Nothing matches "<span className="text-slate-300 italic">{search}</span>".
            </p>
